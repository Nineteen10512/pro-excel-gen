...
TEMPLATES: dict[str, dict] = {
    ...
    "sales_funnel": {
        "name": "sales_funnel",
        "label": "Sales Funnel",
        "description": "Stage-by-stage funnel workbook with conversion, weighted pipeline, and loss-reason review fields.",
        "keywords": ["sales funnel", "funnel", "conversion", "lead", "opportunity", "stage", "win rate"],
    },
    "inventory_tracker": {
    ...
    "project_gantt": {
        "name": "project_gantt",
        "label": "Project Gantt",
        "description": "Project schedule workbook with task owners, start/end dates, progress, dependency notes, and Gantt-ready columns.",
        "keywords": ["gantt", "project gantt", "schedule", "milestone", "dependency", "roadmap"],
    },
}
